  ...
  return (
    <div className="drawer lg:drawer-open">
      ...
      <div className="drawer-content">
        {/* Navbar */}
        <nav className="navbar w-full bg-white shadow-xs">
          <Logo></Logo>
        </nav>
        {/* Page content here */}
        <Outlet></Outlet>
      ...
      <div className="drawer-side is-drawer-close:overflow-visible">
        ...
        <div className="flex min-h-full flex-col items-start bg-secondary is-drawer-close:w-14 is-drawer-open:w-64">
          ...
          <ul className="menu w-full grow">
            <div className="flex items-center justify-between border-b py-1.5 border-gray-300 ">
              <span className="is-drawer-close:hidden font-bold text-2xl text-gray-300">Dashboard</span>
              <div className="">
                <label
                  htmlFor="my-drawer-4"
            ...
            <li className="absolute bottom-8 w-full">
              <Link to={"/"}>
                <button
                  className="is-drawer-close:tooltip flex items-center gap-1.5 is-drawer-close:tooltip-right"
                  data-tip="Homepage"
                >
                  {/* Home icon */}
                  <svg
