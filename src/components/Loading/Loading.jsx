...
const Loading = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-[200px]">
        ...
        <div className="truckWrapper">
          <div className="truckBody">
            <svg
              ...
              className="trucksvg"
            >
              {/* Main Cabin - Colored with #caeb66 */}
              <path
                strokeWidth="3"
                stroke="#282828"
                fill="#caeb66"
          ...
          <div className="truckTires">
            <svg fill="none" viewBox="0 0 30 30" className="tiresvg">
              <circle
                strokeWidth="3"
                stroke="#282828"
                fill="#282828"
      ...
      <p className="mt-4 text-secondary font-bold text-sm tracking-widest animate-pulse">
        LOADING ZAPSHIFT...
      </p>
    </div>
  );
